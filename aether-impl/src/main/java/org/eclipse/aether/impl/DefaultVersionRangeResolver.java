    ...
    implements VersionRangeResolver, Service
{
                                 ...
                                 RepositoryEventDispatcher repositoryEventDispatcher, LoggerFactory loggerFactory )
    {
        ...
        addSyncContextFactory( syncContextFactory );
        addLoggerFactory( loggerFactory );
        addRepositoryEventDispatcher( repositoryEventDispatcher );
    }

    public void initService( ServiceLocator locator )
    {
        addLoggerFactory( locator.getService( LoggerFactory.class ) );
        addMetadataResolver( locator.getService( MetadataResolver.class ) );
        addSyncContextFactory( locator.getService( SyncContextFactory.class ) );
        addRepositoryEventDispatcher( locator.getService( RepositoryEventDispatcher.class ) );
    }

    public DefaultVersionRangeResolver addLoggerFactory( LoggerFactory loggerFactory )
    {
    ...
    public DefaultVersionRangeResolver addMetadataResolver( MetadataResolver metadataResolver )
    {
    ...
    public DefaultVersionRangeResolver addSyncContextFactory( SyncContextFactory syncContextFactory )
    {
    ...
    public DefaultVersionRangeResolver addRepositoryEventDispatcher( RepositoryEventDispatcher repositoryEventDispatcher )
    {
